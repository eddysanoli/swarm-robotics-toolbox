function [d_min, varargout] = getDistPoint2Poly(xp, yp, xv, yv, varargin)
...
% points INSIDE the polygon. NOTA: Comentada esta funcionalidad para el
% caso de la PSO Toolbox ya que no se necesita conocer si el punto está
